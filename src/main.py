...
pygame.display.set_caption("First Game!(ship shooter!!!)")
...
BULLET_HIT_SOUND = pygame.mixer.Sound(os.path.join("Assets_Pygame", "Grenade+1.mp3"))
BULLET_FIRE_SOUND = pygame.mixer.Sound(
    os.path.join("Assets_Pygame", "Gun+Silencer.mp3")
)
...
SPACE = pygame.transform.scale(
    pygame.image.load(os.path.join("Assets_Pygame", "space.png")),
    (WIDTH, HEIGHT),
)
